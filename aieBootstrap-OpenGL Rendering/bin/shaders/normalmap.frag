...
void main() {
	...
	for (int i = 0; i < 2; i++) {
		...
		vec3 diffuse = Lights[i][DIFFUSE] * Kd * texDiffuse * OrenNayar; //lambertTerm;
		vec3 specular = Lights[i][SPECULAR] * Ks * texSpecular * CookTorrance; //specularTerm;
